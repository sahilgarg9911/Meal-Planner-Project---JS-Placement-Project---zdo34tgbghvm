const userHeight = document.querySelector("#height"); //apiKey=dfa76644eeb6444bb9990d8d5f059e2f
...
fetch(`https://api.spoonacular.com/mealplanner/generate?apiKey=3ce9298c607f4739a1349e61ece485fa&timeFrame=day`)
    .then((responce) =>
        responce.json())
    .then((data) => {
...
function myFun(id) {
    ...
    fetch(`https://api.spoonacular.com/recipes/${id}/information?apiKey=3ce9298c607f4739a1349e61ece485fa`)
...
function equipment(id) {
    ...
    fetch(`https://api.spoonacular.com/recipes/${id}/equipmentWidget.json?apiKey=3ce9298c607f4739a1349e61ece485fa`)
        .then((responce) => responce.json())
        .then((res) => {
...
function mealFun() {
    ...
    fetch(`https://api.spoonacular.com/mealplanner/generate?apiKey=3ce9298c607f4739a1349e61ece485fa&timeFrame=day&targetCalories=${calory}`)
        .then((responce) =>
            responce.json())
        .then((data) => {
            console.log(data);
